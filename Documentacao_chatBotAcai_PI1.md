...
|RF13|Gerenciar Códigos de Pagamento e Id dos Pedidos | O sistema deve gerenciar o código de pagamento, pix ou cartão (codigo_pagamento (pix = 1; cartão = 2)), assim como o id do pedido (id_pedido), recem armazenado para atualização do status do pedido.|
